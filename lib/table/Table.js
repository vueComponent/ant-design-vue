  ...
  methods: {
    ...
    renderRowSelection: function renderRowSelection(locale) {
      ...
      if (rowSelection) {
        ...
        if (rowSelection.type !== 'radio') {
          ...
          selectionColumn.title = h(_SelectionCheckboxAll2['default'], {
            attrs: {
              store: this.store,
              locale: locale,
              data: data,
    ...
    recursiveSort: function recursiveSort(data, sorterFn) {
      ...
      return data.sort(sorterFn).map(function (item) {
        return item[childrenColumnName] ? (0, _extends5['default'])({}, item, (0, _defineProperty3['default'])({}, childrenColumnName, _this11.recursiveSort(item[childrenColumnName], sorterFn))) : item;
      });
    },
    ...
    createComponents: function createComponents() {
      ...
      if (!this.customComponents || bodyRow !== preBodyRow) {
        ...
        this.customComponents.body = (0, _extends5['default'])({}, components.body, {
