...
var TreeNode = {
  ...
  props: (0, _propsUtil.initDefaultProps)({
    eventKey: _vueTypes2['default'].string, // Pass by parent `cloneElement`
  ...
  methods: {
    onUpCheckConduct: function onUpCheckConduct(treeNode, nodeChecked, nodeHalfChecked) {
      ...
      if ((0, _util.isCheckDisabled)(this)) {
    ...
    renderSwitcher: function renderSwitcher() {
      ...
      return h('span', {
        'class': (0, _classnames2['default'])(prefixCls + '-switcher', prefixCls + '-switcher_' + (expanded ? ICON_OPEN : ICON_CLOSE)),
        on: {
          'click': this.onExpand
        }
      });
    ...
    renderIcon: function renderIcon() {
      ...
      return h('span', {
        'class': (0, _classnames2['default'])(prefixCls + '-iconEle', prefixCls + '-icon__' + (this.getNodeState() || 'docu'), loadStatus === LOAD_STATUS_LOADING && prefixCls + '-icon_loading')
      });
    },
    ...
    renderSelector: function renderSelector() {
      ...
      var treeIcon = (0, _propsUtil.getComponentFromProp)(this, 'icon') || $scopedSlots.icon;
    ...
    renderChildren: function renderChildren() {
      ...
      if (openTransitionName) {
        animProps = (0, _getTransitionProps2['default'])(openTransitionName, { appear: transitionAppear });
  ...
  render: function render() {
    ...
    return h(
      'li',
      {
        'class': (_ref3 = {}, (0, _defineProperty3['default'])(_ref3, prefixCls + '-treenode-disabled', disabled), (0, _defineProperty3['default'])(_ref3, 'drag-over', !disabled && dragOver), (0, _defineProperty3['default'])(_ref3, 'drag-over-gap-top', !disabled && dragOverGapTop), (0, _defineProperty3['default'])(_ref3, 'drag-over-gap-bottom', !disabled && dragOverGapBottom), (0, _defineProperty3['default'])(_ref3, 'filter-node', filterTreeNode && filterTreeNode(this)), _ref3),
        on: {
