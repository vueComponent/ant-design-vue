...
const editableProps = () => ({
  ...
  onSave: [Function, Array] as PropType<(val: string) => void>,
  onCancel: [Function, Array] as PropType<() => void>,
  onEnd: [Function, Array] as PropType<() => void>,
  onChange: [Function, Array] as PropType<(val: string) => void>,
