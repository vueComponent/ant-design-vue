...
| subtitle | label 标签的副标题 | string |  |  |
| labelTooltip | label 标签的 tooltip 说明 | string |  |  |
| labelExtra | label 标签的额外内容 | string\|slot |  |  |
| labelExtraRight | label 标签的额外内容是否靠右对齐 | boolean | false |  |
